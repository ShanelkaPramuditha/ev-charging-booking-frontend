		...
		<Dialog open={open} onOpenChange={onOpenChange}>
			<DialogContent>
				<DialogHeader>
					...
					<DialogDescription>
						Cancelling a booking will mark it as cancelled. Operators and
						Backoffice can cancel a booking at any time.
					</DialogDescription>
				</DialogHeader>
						...
						<FormField
							...
							render={({ field }) => (
								<FormItem>
									...
									<FormControl>
										<Textarea
											placeholder='Provide a brief reason (min 10 chars)'
											{...field}
										/>
									</FormControl>
									<FormMessage />
